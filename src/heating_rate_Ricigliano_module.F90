!***********************************************************************
!
!     module: heating_rate_Ricigliano_module
!
...
!     grid are initialized by providing the minimal values and the
!     steps.
!      
...
!=======================================================================
      ...
      subroutine read_heating_table(filename)
...
12    format(5es12.4)
      ...
      end subroutine read_heating_table
...
!=======================================================================
      ...
      subroutine set_tau_index(tau,itau,d_tau)
...
!     d_tau ... normalized distance of tau from the itau points [-]
!      
!-----------------------------------------------------------------------
...
!=======================================================================
      ...
      subroutine set_s_index(s,is,d_s)
...
!-----------------------------------------------------------------------
      ...
      end subroutine set_s_index

!=======================================================================

!=======================================================================
!
!     subroutine: set_ye_index
!              
!     This subroutine computes the index of the grid entry immediately
...
!=======================================================================
      ...
      subroutine set_ye_index(ye,iye,d_ye)
...
!=======================================================================
      ...
      subroutine interp_heating_coeff(tau,s,ye,A_int)
...
!.....find the relevant indexes
      call set_tau_index(tau,itau,d_tau)
      call set_s_index(s,is,d_s)
      call set_ye_index(ye,iye,d_ye)
...
!      write(6,*)ye,ye_grid(iye),ye_grid(iye+1),d_ye
      ...
      end subroutine interp_heating_coeff
...
!=======================================================================
      ...
      subroutine calc_heating_rate(tau,s,ye,t,eps)
...
!-----------------------------------------------------------------------
      ...
      call interp_heating_coeff(tau,s,ye,A_int)
...
!.....compute the heating rate..........................................
      ...
      end subroutine calc_heating_rate
...
!=======================================================================
      ...
      subroutine calc_heating_rate_t_array(ntime,tau,s,ye,t_ar,eps_ar)
...
!.....compute the heating rate..........................................
      ...
      end subroutine calc_heating_rate_t_array

!=======================================================================

      end module heating_rate_Ricigliano_module
